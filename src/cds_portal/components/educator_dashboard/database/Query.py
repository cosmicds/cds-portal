...
class QueryCosmicDSApi:
    ...
    def get_class_data(self, class_id=None, student_ids=None, story=None):
        ...
        if student_ids is None:
            ...
            measurements = [
                m
                for m in self.get_all_data(story=story, transpose=False)["measurements"]
                if filter_fun(m)
            ]
            ...
            measurements = [
                self.get_student_data(student_id)["measurements"]
        ...
        if len(measurements) == len(roster):
            ...
            missing_students = [
                ...
                if student["student_id"] not in [m["student_id"] for m in measurements]
            ]
